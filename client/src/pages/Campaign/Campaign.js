...
import { calculateBarPercentage, calcDaysLeft } from "utils";
...
const Campaign = () => {
  ...
  const numDaysLeft = calcDaysLeft(state.deadline);
  ...
  const onDonateBtnHandler = async () => {
    setIsLoading(true);
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <Button
                ...
                handleClick={onDonateBtnHandler}
              />
            </div>
          </div>
        </div>
